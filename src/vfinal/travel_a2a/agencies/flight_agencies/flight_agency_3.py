...
def search_trips(origin: str, destination: str, date: str | None, quality: str | None) -> List[Dict[str, Any]]:
    """
    Busca viajes en avión desde un origen a un destino en una fecha y calidad determinadas.
    ...
    csv_path = data_dir / "flight_agency_3.csv"
...
a2a_app = to_a2a(agent, port=8016)